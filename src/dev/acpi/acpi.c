...
void* init_acpi_vt(void* rsdp_address) {
    ...
    printf("RSDPv2 at: 0x%llx Sig: %s Check: %d OEM: %s Rev: %d RsdtAddr: 0x%llx Len: 0x%llx XsdtAddr: 0x%llx ExtCheck: %d Res: %s\n",
...
void* init_acpi_vz(void* rsdp_address) {
    ...
    printf("RSDP at: 0x%llx Sig: %s Check: %d OEM: %s Rev: %d RsdtAddr: 0x%llx\n",
